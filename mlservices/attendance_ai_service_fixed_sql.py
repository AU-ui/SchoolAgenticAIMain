# ============================================================================
# SMART ATTENDANCE AI/ML SERVICE - FIXED SQL
# ============================================================================
...
class AttendanceAIService:
    def __init__(self, db_config=None):
        ...
        if db_config is None:
            # Use the CORRECT password: 4321 (same as backend)
            self.db_config = {
                'host': 'localhost',
                'port': 5432,
                'database': 'edtech_platform',
                'user': 'postgres',
                'password': '4321',  # CORRECT PASSWORD!
                'connect_timeout': 2,
                'sslmode': 'disable'
            }
        else:
        ...
        print(f" Using CORRECT password: 4321")
    ...
    def connect_db(self):
        """Connect to PostgreSQL database with correct password"""
        try:
    ...
    def get_attendance_data(self, student_id=None, class_id=None, days=90):
        """
        Fetch attendance data from database - FIXED SQL QUERY
        """
        ...
        try:
            # FIXED: Changed 'as' to 'ats' to avoid reserved keyword
            query = """
                SELECT 
                    ar.student_id,
                    ar.status,
                ...
                WHERE ats.session_date >= CURRENT_DATE - INTERVAL '%s days'
            """
...
if __name__ == '__main__':
    ...
    print("🔑 Using correct password: 4321")
    print("🔧 Fixed SQL query syntax")
