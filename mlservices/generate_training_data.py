# ============================================================================
# TRAINING DATA GENERATOR FOR SMART ATTENDANCE
# ============================================================================
# Generates realistic training data for AI/ML models
# Features: Students, classes, teachers, attendance patterns
# ============================================================================
...
class TrainingDataGenerator:
    ...
    def generate_attendance_data(self, classes, students, days_back=90):
        ...
        try:
            ...
            for class_id in classes:
                # Get students for this class (randomly assign 15-25 students per class)
                class_students = random.sample(students, random.randint(15, min(25, len(students))))
                ...
                while current_date <= datetime.now():
                    ...
                    if current_date.weekday() < 5:  # Monday to Friday
                        ...
                        for student_id in class_students:
                            ...
                            # Good students: 90-95% attendance
                            # Average students: 75-85% attendance
                            # Struggling students: 60-75% attendance
    ...
    def generate_analytics(self):
        """Generate pre-calculated analytics"""
        conn = self.connect_db()
        if not conn:
            return
        ...
        try:
            ...
            for period_type, days in periods:
                print(f"📊 Generating {period_type} analytics...")
                
                cursor.execute("""
                    INSERT INTO attendance_analytics (student_id, class_id, period_type, period_start, period_end, 
                                                    total_sessions, present_count, absent_count, late_count, excused_count, attendance_percentage)
                    SELECT 
                        ar.student_id,
                        as.class_id,
                        %s as period_type,
                        CURRENT_DATE - INTERVAL '%s days' as period_start,
                    ...
                    GROUP BY ar.student_id, as.class_id
                    ON CONFLICT (student_id, class_id, period_type, period_start, period_end) 
                    DO UPDATE SET
    ...
    def generate_all_training_data(self):
        ...
        print(f"✅ Attendance Records: ~{len(students) * len(classes) * 90} records")
