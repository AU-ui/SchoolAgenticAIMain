# ============================================================================
# TRAINING DATA GENERATOR - SIMPLE FINAL VERSION
# ============================================================================
# No dotenv dependency - tries multiple passwords automatically
# ============================================================================
...
def find_working_password():
    """Find the working password by trying common ones"""
    passwords_to_try = ['1234', 'password', 'postgres', 'admin', 'root', '', 'your_password']
