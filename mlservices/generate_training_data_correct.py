# ============================================================================
# TRAINING DATA GENERATOR - CORRECTED FOR YOUR SETUP
# ============================================================================
# Generates training data for your PostgreSQL 17 database
# ============================================================================
...
from mlservices.db_config import DB_CONFIG
...
def create_training_data():
    ...
    try:
        ...
        if 'attendance_sessions' not in existing_tables:
            ...
            # Read and execute the attendance schema
