-- ============================================================================
-- WORKING ATTENDANCE SYSTEM DATABASE SETUP
-- ============================================================================
-- This script fixes ALL data type issues and variable conflicts
-- ============================================================================
        ...
        FOR i IN 0..6 LOOP
            ...
            IF EXTRACT(DOW FROM v_session_date) NOT IN (0, 6) THEN
                ...
                IF v_existing_sessions = 0 THEN
                    ...
                    VALUES (class_record.class_id, class_record.teacher_id, v_session_date, '09:00:00'::TIME, 'regular', 'completed')
                    ...
                    LOOP
                        ...
                        -- Set arrival time based on status
                        IF random() < 0.90 THEN
                            v_arrival_time := '08:55:00'::TIME; -- 5 minutes early
                        ELSIF random() < 0.95 THEN
                            v_arrival_time := '09:15:00'::TIME; -- 15 minutes late
                        ELSE
                            v_arrival_time := NULL; -- absent
                        END IF;
