...
-- ============================================================================
-- This script handles existing tables and missing constraints
-- ============================================================================
...
-- ============================================================================
-- 2. CREATE TEST DATA (WITHOUT ON CONFLICT)
-- ============================================================================
...
BEGIN
    ...
    SELECT school_id, 'Mathematics 101', 9, '2024-2025', teacher_id, true
    WHERE NOT EXISTS (SELECT 1 FROM classes WHERE school_id = school_id AND name = 'Mathematics 101' AND academic_year = '2024-2025');
    
    INSERT INTO classes (school_id, name, grade_level, academic_year, teacher_id, is_active)
    SELECT school_id, 'Science 101', 9, '2024-2025', teacher_id, true
    WHERE NOT EXISTS (SELECT 1 FROM classes WHERE school_id = school_id AND name = 'Science 101' AND academic_year = '2024-2025');
    
    INSERT INTO classes (school_id, name, grade_level, academic_year, teacher_id, is_active)
    SELECT school_id, 'English 101', 9, '2024-2025', teacher_id, true
    WHERE NOT EXISTS (SELECT 1 FROM classes WHERE school_id = school_id AND name = 'English 101' AND academic_year = '2024-2025');
